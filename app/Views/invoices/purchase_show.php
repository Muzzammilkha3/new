<div class="d-flex justify-content-between align-items-center mb-3">
    <h3>Purchase Invoice <?= htmlspecialchars($invoice['invoice_number']) ?></h3>
    <button class="btn btn-outline-secondary" onclick="window.print()">Print / PDF</button>
</div>
<p><strong>Date:</strong> <?= htmlspecialchars($invoice['invoice_date']) ?> | <strong>Supplier:</strong> <?= htmlspecialchars($invoice['supplier_name'] ?? '-') ?></p>
